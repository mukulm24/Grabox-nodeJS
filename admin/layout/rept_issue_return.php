 ...
 <?php include("left_sidebar.php");?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Datewise Issue Return Report
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Layout</a></li>
        <li class="active">Datewise Issue Return Report</li>
      </ol>
    </section>
    ...
    $sqlVendors="select d.id, i.issueOrder,d.issueReturnDate,
                      d.itemId,d.quantity,issue.branchId from return_issue_order i 
  ...
  function getData(){
    ...
    myform.setAttribute("target", "_blank");
      ...
      document.getElementById("myform").action='report_issue_return.php?issueOrder='+issueOrder;
