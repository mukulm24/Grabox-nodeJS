 ...
 <?php include("left_sidebar.php");?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Received Item Stock Report
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Layout</a></li>
        <li class="active">Received Item Stock Report</li>
      </ol>
    </section>

    <?php

    $sqlVendors ="select * from vendor order by id desc";
        ...
        <div class="row">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3">
               <select name="vendorId" id="vendorId" class="form-control select2itemId" style="width: 100%;">
                  <option value="">Select</option>
                  <?php 
                                   
                    while ($rowVendors=mysql_fetch_array($resultVendors)) {

                        echo '<option value='.$rowVendors['id'].'>'.$rowVendors['vendorName'].'</option>';                    
  ...
  function getData(){
    ...
    myform.setAttribute("target", "_blank");
      ...
      document.getElementById("myform").action='report_vendor_stock.php?vendorId='+vendorId;
