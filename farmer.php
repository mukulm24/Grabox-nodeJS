...
<div class="banner">
	<div id="content12" class="container-fluid-update">
		<img src="images/banner2.jpg" alt="We Bring" data-url="#1" style="height: 100%;width:100%">
		...
		<div class="container">
			<div class="row">
	            <div class="col-lg-5 col-sm-6">
					...
					<p class="text-center">Please provide your details to connect with us.</p>
					<form action="#" method="post">
						...
						<div class="form-group col-lg-4">
							<label>Phone No.<span class="starColor">*</span></label>
							<input type="tel" name="mobileNo" class="form-control" placeholder="Enter 10-digit mobile no." required>
						</div>
						<div class="form-group col-lg-4">
							<label>Password<span class="starColor">*</span></label>
							<input type="password" name="password" class="form-control" placeholder="Password" required>
						</div>
						<div class="form-group col-lg-4">
							<label>Confirm Password<span class="starColor">*</span></label>
							<input type="password" name="password" class="form-control" placeholder="Confirm Password" required>
						</div>
						<div class="form-group col-lg-4">
							<label>Address<span class="starColor">*</span></label>
							<input type="text" name="address" class="form-control" placeholder="Address" required>
						</div>
						
						
						<div class="form-group col-md-12 col-sm-12 col-xs-12 col-lg-4">
							<input type="radio" name="userType" checked>
							<label style="padding-right:20px;">Retailer</label>
							<input type="radio" name="userType">
							<label style="padding-right:20px;">Farmer</label>
						</div>
...
-->
    <div class="footer-below">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>© 2016 Vegetable Farm. All Rights Reserved | Design by <a href="" target="_blank"></a></p>
                </div>
            </div>
        </div>
